...
const LandingPage = () => {
  ...
  return (
    <div className="w-full flex justify-center flex-col items-center bg-blue-600">
      ...
      {/* navbar */}
      <div className="w-full h-12 flex justify-center top-0 sticky bg-blue-50 text-slate-500 shadow-xl z-30">
        <div className="w-11/12 lg:w-4/6 flex justify-between items-center relative">
          ...
          <div className="absolute right-0">
            ...
            >
              <p className="cursor-pointer hover:underline hover:text-slate-700 transition-all ease-in-out mx-6 lg:mx-0">
                <Link
                  to={"/#product"}
                  onClick={() => {
                    setIsBurger(false);
